...
REAL8 Jpa2_Approx(int p, int a, REAL8 e)
{
    ...
    if (absp >= 10) {
        ...
        // print_debug("coeffs = %.16e, %.16e, %.16e\n",
        //     COEFFSJb2_jh[inda][absp-10][0], 
        //     COEFFSJb2_jh[inda][absp-10][1],
        //     COEFFSJb2_jh[inda][absp-10][2]);
        if (absp >= 50)
            epr_cheby = 
...
REAL8 Jpa3_Approx(int p, int a, REAL8 e)
{
    ...
    if (absp >= 15) {
        ...
        // if (e<0.1) {
        //     print_debug("cheby = \n\t%.16e, %.16e, %.16e\n\t%.16e, %.16e, %.16e\n\t%.16e, %.16e, %.16e\n", 
        //         COEFFSJb3_cheby[ia][ip][0], COEFFSJb3_cheby[ia][ip][1], COEFFSJb3_cheby[ia][ip][2],
        //         COEFFSJb3_cheby[ia][ip][3], COEFFSJb3_cheby[ia][ip][4], COEFFSJb3_cheby[ia][ip][5],
        //         COEFFSJb3_cheby[ia][ip][6], COEFFSJb3_cheby[ia][ip][7], COEFFSJb3_cheby[ia][ip][8]);
        // }
...
REAL8 dJpa2_Approx(INT p, INT a, REAL8 e)
{
    ...
    // return -exp(lnPref+lneprL)*(1. + e14*( deltae*epr_cheby + COEFFSdJb1_a1_jhc[absp-1][7] ));
}
